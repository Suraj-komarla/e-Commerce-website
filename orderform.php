...
//triming name
	try {
		...
		// Check if email already exists
						...
						$k=mysql_query("SELECT available FROM products WHERE id='$poid'");
						$q=$k-$quan;
						echo "$k";
						mysql_query("UPDATE products SET available='$q' WHERE id='$poid'");
						}else{
...
<body style="background-image: url(image/homebackgrndimg1.png);">
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="grocery/vegetables.php" style="text-decoration: none;color: #fff;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Vegetables</a>
				</th>
				<th><a href="grocery/fruits.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Fruits</a></th>
				<th><a href="grocery/bakery.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Bakery</a></th>
				<th><a href="grocery/household.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Household</a></th>
				<th><a href="grocery/grains.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Grains</a></th>
				<th><a href="grocery/pulses.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Pulses</a></th>
				<th><a href="grocery/diary.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Diary</a></th>
				<th><a href="grocery/cereal.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Cereal</a></th>
			</tr>
		</table>
	</div>
